...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [f1,RP,FS]=load_play_circuit_MMN_nel(FS_tag,fig_num,GB_ch)
...
% edited by Andrew Sivaprakasam & Michael Heinz
% in Nov 2021, based on Hannah Ginsberg MEMR work
%------------
warning('off'); 

CIR_PATH='MMN_play_rec.rcx'; %The *.rco circuit used to play the files
...
% frequencies (in Hz): Found in FS_vec.
