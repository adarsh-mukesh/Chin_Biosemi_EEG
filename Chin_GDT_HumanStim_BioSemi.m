...
try
    ...
    %     ntrials = 1500;
    ntrials = 600;  % no. of times each stim is played
    ...
    %
    %
    %     [x_16, ~] = audioread('C:\Users\Heinz Lab - NEL2\Desktop\Andrew_EEG\ACC_HeinzLab\Acquisition_MP\stims\gdt_chum_16ms.wav');
    %     [x_32, ~] = audioread('C:\Users\Heinz Lab - NEL2\Desktop\Andrew_EEG\ACC_HeinzLab\Acquisition_MP\stims\gdt_chum_32ms.wav');
    %     [x_64, ~] = audioread('C:\Users\Heinz Lab - NEL2\Desktop\Andrew_EEG\ACC_HeinzLab\Acquisition_MP\stims\gdt_chum_64ms.wav');
    ...
    for j = 1:length(triglist)
        ...
        stimTrigger = triglist(j); % 1 , 2 or 3
